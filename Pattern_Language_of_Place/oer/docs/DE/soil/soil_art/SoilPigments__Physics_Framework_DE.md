...
| **Mathematik** | Farben sortieren, zählen | Diagramme, Siebfraktionen als Prozent | Regression, Δ*E*-Werte, statistische Korrelation |
...
| Mathematik | Statistik, Regressionsanalyse, Δ*E*-Berechnung |
...
*Dieses Material ist Teil der Erdpuls-OER-Sammlung und steht als Open Educational Resource (OER) unter der Creative-Commons-Lizenz CC BY-NC-SA 4.0 zur Verfügung.*
